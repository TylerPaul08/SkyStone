...
@Autonomous(name="RedPlateformAuto", group="chad")

public class RedPlateformAuto extends LinearOpMode
{
    //
    DcMotor frontleft;
    DcMotor frontright;
    ...
    public void runOpMode(){
        ...
        waitForStartify();
        strafeToPosition(32, 0.9);

        //Drives forward
        moveToPosition(42, 0.8);
        telemetry.addData("Go time","Moved to plate" );

        //Grabs the foundation
        PlateGrabber();
        telemetry.addData("Go Time","plate grabbed");
        ...
        telemetry.addData("Go Time","moving plate back");
        ...
        PlateUnGrabber();
        telemetry.addData("Go Time","ungrabbing plate");
